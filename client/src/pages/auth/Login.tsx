...
const Login = () => {
    ...
    const handleSubmit: React.FormEventHandler<HTMLFormElement> = async (e) => {
            ...
            // На всяк випадок очищаємо попередню помилку
            setErrMsg("");
            ...
            try {
                ...
                // Можеш залишити цей лог, щоб бачити у консолі, що реально повертає бекенд
                ...
                // Тут розкладемо error-handling нормально по гілках
                if (!err?.response) {
